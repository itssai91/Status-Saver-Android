...
import net.hostranger.statussaver.adapter.WhatsappStatusAdapter;
import net.hostranger.statussaver.databinding.FragmentWhatsappImageBinding;
import net.hostranger.statussaver.model.WhatsappStatusModel;
